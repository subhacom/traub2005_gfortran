...
c       WRITE(6,919) time,dt,z1,m
c919     FORMAT(E14.7,X,E14.7,X, E14.7,X,I5,"m RS")
...
c       WRITE(6,924) time,dt,z1,i
c924     FORMAT(E14.7,X,E14.7,X, E14.7,X,I4,"done")
      end do ! i
...
c Handle supbask    -> suppyrRS
      do i = 1, num_supbask_to_suppyrRS
       ...
       do m = 1, outctr_supbask(j)  ! enumerate presyn. spikes
        ...
        delta = time - presyntime
c       WRITE(6,920) time,dt,z1,m
c920     FORMAT(E14.7,X,E14.7,X, E14.7,X,I5,"m")
! GABA-A part
