...
c$$$     &   num_TCR_to_deepaxax       = 10,
c$$$     &   num_TCR_to_nRT            = 25, ! note
c$$$     &   num_TCR_to_nontuftRS      = 10,
c$$$     &   num_nRT_to_TCR            = 15, ! note
c$$$     &   num_nRT_to_nRT            = 10)
        PARAMETER
...
!        GOTO 30
         z1 = 1.25d0  ! for intracortical IPSCs
         z2 = 1.00d0 ! 1.25d0 ! subha - fig2 paper statement does not match hroucho84.f ! for intrathalamic IPSCs, usual 1.00
...
!          z1 = 1.00d0  ! intracortical e/i
           ...
           z3 = 1.00d0 !0.00d0  ! subha - don't we need to cut it for fig2?! TCR -> cortical i ! usual 1.0
           z4 = 1.00d0  ! TCR -> nRT & nontuftRS ->nRT ! usual 1.00
           z2 = 2.00d0 ! 1.00d0  !subha - should it not be usual value! everything else; note that this may be INCREASED, usual 1.0
...
!     goto 60
       z = 0.d0 !1.d0 ! why not 1.0 for - simulating fig2? - subha
