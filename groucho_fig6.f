...
c     amoung all the cells.
     ...
     &  supbask_base/1049/, supaxax_base/1139/,
     &  supLTS_base/1229/, spinstell_base/1319/,
     &  tuftIB_base/1559/, tuftRS_base/2359/,
     &  nontuftRS_base/2559/, deepbask_base/3059/,
     &  deepaxax_base/3159/, deepLTS_base/3259/,
     &  TCR_base/3359/, nRT_base/3459/
...
c$$$         timtot =100.d0   ! projected to take about an hour (took 1 hour 45 min)
...
c$$$            curr_tuftIB    (1,L) = 0.00d0 + 0.1d0 *
     &      ranvec_tuftIB   (L)
...
c$$$            curr_tuftRS    (1,L) = 0.00d0 + 0.1d0 *
     &      ranvec_tuftRS   (L)
...
!     &   ",  ranvec_suppyrFRB(L) = ", ranvec_suppyrFRB(L)
         ...
         do L = 1, num_nontuftRS    
            curr_nontuftRS  (1,L) = 0.10d0 + 0.1d0 *
     &      ranvec_nontuftRS (L)
...
!          z1 = 1.00d0  ! intracortical e/i
           ...
           z2 = 1.00d0  ! everything else; note that this may be INCREASED, usual 1.0
           z = 0.25d0
...
c$$$      gAMPA_spinstell_to_spinstell= z2 * gAMPA_spinstell_to_spinstell
      gAMPA_spinstell_to_spinstell= z * gAMPA_spinstell_to_spinstell ! subha - for fig 6
...
!        GOTO 40
c$$$         z1 = 0.2d0 ! to interneurons
         z1 = 0.5d0 ! to interneurons
! Usual scaling of NMDA to princ. cells, including FRB, is 0.5
         z2 = 0.5d0 ! to  cort. principal cells, except FRB
         z3 = 0.5d0 ! to suppyrFRB
         z4 = 0.5d0  ! to TCR and nRT and from TCR to cort. princ.
         z = 0.25d0 ! subha - special case for fig 6: spinstell-spinstell scaling
...
c$$$      gNMDA_spinstell_to_spinstell= z2 *
c$$$     &  gNMDA_spinstell_to_spinstell
